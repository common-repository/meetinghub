			...
			<div class="mhub-widget-inner">
				<dl>
					...
					<?php if ( $options['enable_recurring_meeting'] && ! empty( $zoom_response->occurrences ) ) { ?>
						<dt><?php esc_html_e( 'Recurring Meeting schedule:', 'meetinghub' ); ?></dt>
						<dd style="margin-bottom:0;"> From: <?php echo esc_html( gmdate( 'd M Y', strtotime( $next_meeting_time ) ) ); ?></dd>
						<dd> To: <?php echo esc_html( $recurring_end_date ); ?></dd>

						<dt><?php esc_html_e( 'Meeting recurrence:', 'meetinghub' ); ?></dt>
						<dd> Every <?php echo esc_html( $recurring_repeat_interval ); ?>  <?php echo esc_html( $recurring_repeat_name ); ?> at <?php echo esc_html( gmdate( 'H:i', strtotime( $next_meeting_time ) ) ); ?>  </dd>
						...
						<dd>
							...
							if ( 60 <= $recurring_duration ) {
								...
								printf(
									...
									esc_html( number_format_i18n( $recurring_duration ) )
								);
							}
							?>
						</dd>
