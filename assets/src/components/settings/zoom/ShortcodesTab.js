...
const shortcodes = [
  { title: "Zoom Meeting List", description: "Embed a list of upcoming Zoom meetings", code: "[mhub-zoom-meeting-list]" },
  { title: "Zoom Webinar List", description: "Embed a list of upcoming Zoom webinars", code: "[mhub-zoom-webinar-list]" },
];
